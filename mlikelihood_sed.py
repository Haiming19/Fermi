...
printResult(like,saveresultto='bestfitted_global.txt')
sp2pl('fitted.xml','sed_in.xml',name)

assert 1
#----------------SED---------------------------
from bdlikeSED import *
inputs=bdlikeInput(like,sourcename+'_filtered_gti.fits',sourcename+'_CCUBE.fits',"/home/zhm/FermiData/3c138/SC.fits",name)
inputs.plotBins()
inputs.fullFit()
